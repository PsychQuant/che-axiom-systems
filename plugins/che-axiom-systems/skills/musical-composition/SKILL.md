...
權威內容以 `domains/musical-composition/音楽作曲と理論の公理化.md`（該域宣告的 entry_point）為準，該檔共 **29 個** `###` 層條目，另有 **10 個** `##` 分組標題（領域定義、アイドル音楽の根本原理、基本公理、導出原理、多次元技術複合体、文化的・歴史的コンテキスト、応用と拡張、限界と考察、今後の理論的発展、特殊応用ケース），兩者都可引用。上表取其中 5 列，**未列**的是公理M5、原理P1–P5（含 P3.1）、MTC1–MTC4、CHC1–CHC3、AE1–AE3、LC1–LC3、FTD1–FTD3、SAC1。不可用於引用。本域用自訂體系、非 ASBE schema，故上表列**章節名**而非 ID——引用時同樣以章節名稱呼，**嚴禁捏造 ID**。 新增公理後**本表要同步**（與 INDEX、TOPICS、domain.yaml 同批）。
